...
public class RelationshipPatternExtractor extends Pipeline {
    ...
    public static void main(String[] arguments) {
        ...
        final Logger l =
            Pipeline.loggingSetup(cmd, opts, "txtfnnl patterns [options] <directory|files...>\n");
        // output options
        ...
        try {
            jdbcResource =
                Pipeline.getJdbcResource(cmd, l, EntityMentionAnnotator.DEFAULT_JDBC_DRIVER,
        ...
        final String entityMapPath =
            cmd.getOptionValue('m', EntityMentionAnnotator.DEFAULT_MAPPING_FILE);
