...
public class RelationshipExtractor extends Pipeline {
  ...
  // default entity set: all human, mouse, and rat gene symbols (roughly 500k symbols)
  ...
  static final String MAMMALIAN_TF_QUERY = "SELECT r.accession, s.value FROM " +
      "genes AS g, gene_strings AS s, gene_refs AS r WHERE g.id = s.id AND g.id = r.id " +
      "AND s.cat = 'symbol' AND r.namespace = 'gi' AND r.accession IN " + MAMMALIAN_TF_IDS;
