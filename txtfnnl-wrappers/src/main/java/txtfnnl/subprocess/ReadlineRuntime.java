...
public abstract class ReadlineRuntime<T> {
   ...
   * @throws IOException
   */
  public ReadlineRuntime(String[] args, String[] envp, File dir, Logger logger) throws IOException {
  ...
  /**
   * Fork out a new {@link Runtime} process using UTF-8 encoding and running with the currently set
  ...
  /**
   * Return a single, trimmed line from the process' output stream. This method should be called by
   * the response parsing implementation and might return <code>null</code> if the forked process'
