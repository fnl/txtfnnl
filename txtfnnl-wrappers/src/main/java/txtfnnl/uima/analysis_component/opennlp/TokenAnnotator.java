...
public class TokenAnnotator extends JCasAnnotator_ImplBase {
     ...
     *        "~/opennlp/models/en-token.bin"; should never be <code>null</code> or the empty
     *        string
    ...
    public static AnalysisEngineDescription configure(String tokenModelFilePath,
        ...
        final ExternalResourceDescription tokenModel =
            ExternalResourceFactory.createExternalResourceDescription(
                TokenizerModelResourceImpl.class, tokenModelFilePath);
        final ExternalResourceDescription posModel =
            ExternalResourceFactory.createExternalResourceDescription(POSModelResourceImpl.class,
                posModelFilePath);
        final ExternalResourceDescription chunkModel =
            ExternalResourceFactory.createExternalResourceDescription(
                ChunkerModelResourceImpl.class, chunkModelFilePath);
        final AnalysisEngineDescription aed =
            AnalysisEngineFactory.createPrimitiveDescription(TokenAnnotator.class,
                RESOURCE_TOKEN_MODEL, tokenModel, RESOURCE_POS_MODEL, posModel,
    ...
    public void process(JCas jcas) throws AnalysisEngineProcessException {
        ...
        while (sentenceIt.hasNext()) {
            ...
            for (int i = 0; i < tokenSpans.length; i++) {
                final TokenAnnotation token =
                    new TokenAnnotation(jcas, sentenceOffset + tokenSpans[i].getStart(),
