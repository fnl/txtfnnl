...
public class TestRelationshipPatternLineWriter {
    ...
    public void setUp() throws UIMAException, IOException {
        ...
        ae =
            AnalysisEngineFactory.createPrimitive(RelationshipPatternLineWriter
    ...
    public void testProcessRelationship() throws AnalysisEngineProcessException {
        ...
        Assert
            .assertTrue(
                ...
                outputStream.toString().startsWith(
                    "[[ns:id]]" + test.substring(0, test.length() - 1)));
    }
    ...
    public void testProcessJCasOutputDir() throws UIMAException, IOException {
        ...
        ae =
            AnalysisEngineFactory.createPrimitive(RelationshipPatternLineWriter.configure(
