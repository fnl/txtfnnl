...
public class TestGeniaTaggerAnnotator {
    ...
    public void producesAnnotations() throws AnalysisEngineProcessException {
        ...
        final String[] tokens =
            new String[] { "ARL", ",", "a", "regulator", "of", "cell", "death", "localized",
                "inside", "the", "nucleus", ",", "has", "been", "shown", "to", "bind", "the",
                "p53", "promoter", "." };
        final String[] chunks =
            new String[] { "NP", null, "NP", "NP", "PP", "NP", "NP", "VP", "PP", "NP", "NP", null,
                "VP", "VP", "VP", "VP", "VP", "NP", "NP", "NP", null };
