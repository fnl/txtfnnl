...
/**
 * Annotations on a specific text span. Updated by JCasGen Tue Nov 27 14:20:54 CET 2012
 * 
 * @generated
 */
public class TextAnnotation_Type extends Annotation_Type {
    ...
    public final static boolean featOkTst = JCasRegistry
        .getFeatOkTst("txtfnnl.uima.tcas.TextAnnotation");
    /** @generated */
    ...
    public String getAnnotator(int addr) {
        if (featOkTst && casFeat_annotator == null) {
            jcas.throwFeatMissing("annotator", "txtfnnl.uima.tcas.TextAnnotation");
        }
    ...
    public double getConfidence(int addr) {
        if (featOkTst && casFeat_confidence == null) {
            jcas.throwFeatMissing("confidence", "txtfnnl.uima.tcas.TextAnnotation");
        }
    ...
    public String getNamespace(int addr) {
        if (featOkTst && casFeat_namespace == null) {
            jcas.throwFeatMissing("namespace", "txtfnnl.uima.tcas.TextAnnotation");
        }
    ...
    public String getIdentifier(int addr) {
        if (featOkTst && casFeat_identifier == null) {
            jcas.throwFeatMissing("identifier", "txtfnnl.uima.tcas.TextAnnotation");
        }
    ...
    public int getProperties(int addr) {
        if (featOkTst && casFeat_properties == null) {
            jcas.throwFeatMissing("properties", "txtfnnl.uima.tcas.TextAnnotation");
        }
    ...
    public int getProperties(int addr, int i) {
        ...
        if (lowLevelTypeChecks)
            return ll_cas.ll_getRefArrayValue(ll_cas.ll_getRefValue(addr, casFeatCode_properties),
                i, true);
    ...
    public TextAnnotation_Type(JCas jcas, Type casType) {
        ...
        casFeat_annotator =
            jcas.getRequiredFeatureDE(casType, "annotator", "uima.cas.String", featOkTst);
        casFeatCode_annotator =
            (null == casFeat_annotator) ? JCas.INVALID_FEATURE_CODE
                : ((FeatureImpl) casFeat_annotator).getCode();
        casFeat_confidence =
            jcas.getRequiredFeatureDE(casType, "confidence", "uima.cas.Double", featOkTst);
        casFeatCode_confidence =
            (null == casFeat_confidence) ? JCas.INVALID_FEATURE_CODE
                : ((FeatureImpl) casFeat_confidence).getCode();
        casFeat_namespace =
            jcas.getRequiredFeatureDE(casType, "namespace", "uima.cas.String", featOkTst);
        casFeatCode_namespace =
            (null == casFeat_namespace) ? JCas.INVALID_FEATURE_CODE
                : ((FeatureImpl) casFeat_namespace).getCode();
        casFeat_identifier =
            jcas.getRequiredFeatureDE(casType, "identifier", "uima.cas.String", featOkTst);
        casFeatCode_identifier =
            (null == casFeat_identifier) ? JCas.INVALID_FEATURE_CODE
                : ((FeatureImpl) casFeat_identifier).getCode();
        casFeat_properties =
            jcas.getRequiredFeatureDE(casType, "properties", "uima.cas.FSArray", featOkTst);
        casFeatCode_properties =
            (null == casFeat_properties) ? JCas.INVALID_FEATURE_CODE
                : ((FeatureImpl) casFeat_properties).getCode();
    }
}
