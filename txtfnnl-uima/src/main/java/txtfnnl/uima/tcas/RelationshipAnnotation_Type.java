...
public class RelationshipAnnotation_Type extends SofaAnnotation_Type {
    ...
    public RelationshipAnnotation_Type(JCas jcas, Type casType) {
        ...
        casFeat_sources =
            jcas.getRequiredFeatureDE(casType, "sources", "uima.cas.FSArray", featOkTst);
        casFeatCode_sources =
            (null == casFeat_sources) ? JCas.INVALID_FEATURE_CODE
                : ((FeatureImpl) casFeat_sources).getCode();
        casFeat_targets =
            jcas.getRequiredFeatureDE(casType, "targets", "uima.cas.FSArray", featOkTst);
        casFeatCode_targets =
            (null == casFeat_targets) ? JCas.INVALID_FEATURE_CODE
                : ((FeatureImpl) casFeat_targets).getCode();
        casFeat_isAuto =
            jcas.getRequiredFeatureDE(casType, "isAuto", "uima.cas.Boolean", featOkTst);
        casFeatCode_isAuto =
            (null == casFeat_isAuto) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl) casFeat_isAuto)
                .getCode();
    }
}
