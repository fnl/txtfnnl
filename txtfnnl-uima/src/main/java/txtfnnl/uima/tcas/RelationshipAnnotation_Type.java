...
public class RelationshipAnnotation_Type extends SofaAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("txtfnnl.uima.tcas.RelationshipAnnotation");
  ...
  public RelationshipAnnotation_Type(JCas jcas, Type casType) {
    ...
    casFeatCode_targets  = (null == casFeat_targets) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_targets).getCode();

 
    casFeat_isAuto = jcas.getRequiredFeatureDE(casType, "isAuto", "uima.cas.Boolean", featOkTst);
    casFeatCode_isAuto  = (null == casFeat_isAuto) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_isAuto).getCode();
