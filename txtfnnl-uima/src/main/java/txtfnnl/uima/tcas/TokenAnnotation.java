 ...
 * Updated by JCasGen Tue Nov 27 14:20:55 CET 2012 XML source:
...
public class TokenAnnotation extends SyntaxAnnotation {
   ...
   * @return a particular token annotation constraint
   */
  public static FSMatchConstraint makeConstraint(JCas jcas, String annotatorUri, String namespace,
      String identifier) {
    return TextAnnotation.makeConstraint(TokenAnnotation.class.getName(), jcas, annotatorUri,
        namespace, identifier);
  }

  /**
   * Return a specialized filter for token annotations.
   * 
   * @param jcas to create the constraint for
   * @param annoatorUri to filter on
   ...
   */
  public static FSMatchConstraint makeConstraint(JCas jcas, String annotatorUri, String namespace) {
    return TokenAnnotation.makeConstraint(jcas, annotatorUri, namespace, null);
  }
  ...
  public static FSMatchConstraint makeConstraint(JCas jcas, String namespace) {
    return TokenAnnotation.makeConstraint(jcas, null, namespace);
  }
  ...
  public String getPos() {
    if (TokenAnnotation_Type.featOkTst && ((TokenAnnotation_Type) jcasType).casFeat_pos == null) {
      jcasType.jcas.throwFeatMissing("pos", "txtfnnl.uima.tcas.TokenAnnotation");
    }
  ...
  public String getStem() {
    if (TokenAnnotation_Type.featOkTst && ((TokenAnnotation_Type) jcasType).casFeat_stem == null) {
      jcasType.jcas.throwFeatMissing("stem", "txtfnnl.uima.tcas.TokenAnnotation");
    }
    return jcasType.ll_cas.ll_getStringValue(addr,
  ...
  public String getChunk() {
    if (TokenAnnotation_Type.featOkTst && ((TokenAnnotation_Type) jcasType).casFeat_chunk == null) {
      jcasType.jcas.throwFeatMissing("chunk", "txtfnnl.uima.tcas.TokenAnnotation");
    }
    return jcasType.ll_cas.ll_getStringValue(addr,
  ...
  public void setChunk(String v) {
    ...
    jcasType.ll_cas
        .ll_setStringValue(addr, ((TokenAnnotation_Type) jcasType).casFeatCode_chunk, v);
  }
