...
public class TextAnnotation extends Annotation {
    ...
    protected static FSMatchConstraint makeConstraint(String typeName, JCas jcas,
        ...
        if (annotatorUri != null) {
            constraint =
                TextAnnotation.createConstraint(typeName + ":annotator", jcas, annotatorUri, cf);
        }
        if (namespace != null) {
            if (constraint == null) {
                constraint =
                ...
                constraint =
                    cf.and(constraint, TextAnnotation.createConstraint(typeName + ":namespace",
                        jcas, namespace, cf));
            }
        }
        if (identifier != null) {
            if (constraint == null) {
                constraint =
                    TextAnnotation
                        .createConstraint(typeName + ":identifier", jcas, identifier, cf);
            } else {
                constraint =
                    cf.and(constraint, TextAnnotation.createConstraint(typeName + ":identifier",
                        jcas, identifier, cf));
            }
        }
        return constraint;
    ...
    // * Feature: annotator
    /**
     * getter for annotator - gets A URI identifying the annotator (humans: e-mail, automated:
     * URL).
     * 
     * @generated
     */
    ...
    /**
     * setter for annotator - sets A URI identifying the annotator (humans: e-mail, automated:
     * URL).
     * 
     * @generated
     */
    ...
    // * Feature: identifier
    /**
     * getter for identifier - gets The annotation type ID that should usually form a fully valid
     * URL by joining the namespace and this value with a slash ("/").
     * 
     * @generated
     */
    ...
    /**
     * setter for identifier - sets The annotation type ID that should usually form a fully valid
     * URL by joining the namespace and this value with a slash ("/").
     * 
     * @generated
     */
