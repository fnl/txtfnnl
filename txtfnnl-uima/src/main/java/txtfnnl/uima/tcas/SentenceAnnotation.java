 ...
 * JCasGen Tue Nov 27 14:20:55 CET 2012 XML source: /Users
...
public class SentenceAnnotation extends SyntaxAnnotation {
  ...
  public static FSMatchConstraint makeConstraint(JCas jcas, String annotatorUri, String namespace,
      String identifier) {
    return TextAnnotation.makeConstraint(SentenceAnnotation.class.getName(), jcas, annotatorUri,
   ...
   */
  public static FSMatchConstraint makeConstraint(JCas jcas, String annotatorUri, String namespace) {
    return SentenceAnnotation.makeConstraint(jcas, annotatorUri, namespace, null);
  }
  ...
  public static FSMatchConstraint makeConstraint(JCas jcas, String namespace) {
    return SentenceAnnotation.makeConstraint(jcas, null, namespace);
  }
