...
public class TextWriter extends CasConsumer_ImplBase {
    /**
     * Optional configuration parameter String that defines the path to a directory where the
     ...
     * unique; otherwise the existing file is replaced (where <b>n</b> is the first positive
     * integer that makes the file name "unique").
     */
    ...
    /**
     * Configure a default TextWriter descriptor for a pipeline. Writes to STDOUT using the
