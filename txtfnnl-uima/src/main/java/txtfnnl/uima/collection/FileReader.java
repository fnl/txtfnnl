...
/**
 * A collection reader for an array of file paths.
 * 
...
public class FileReader extends CasCollectionReader_ImplBase {
	...
	/**
	 * A list of input files for this reader to process.
	 * 
	...
	private Tika tika = new Tika(); // for the MIME type detection
	...
	public static CollectionReaderDescription configure(String[] filePaths) throws UIMAException,
	        IOException {
		return configure(filePaths, null);
	}
