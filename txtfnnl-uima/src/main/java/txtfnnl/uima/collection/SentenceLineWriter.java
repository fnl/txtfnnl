...
public class SentenceLineWriter extends TextWriter {
     ...
     * option, all (consecutive) Unicode spaces will be normalized to a single ASCII white-space
     * and the sentences are (space-) trimmed.
     */
     ...
     * @return a trimmed String where the single line-breaks are replaced with a white-space and
     *         all Unicode spaces have been normalized
     */
