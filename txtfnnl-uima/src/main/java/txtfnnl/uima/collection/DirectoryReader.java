...
/**
 * A collection reader from a directory containing the input files, possibly
 * traversing any sub-directories.
 * 
 * The MIME type of the input files can be predetermined or automatically
 * detected.
 * 
...
public class DirectoryReader extends CasCollectionReader_ImplBase {
	...
	/**
	 * Optional parameter defining the MIME type of all input files.
	 * 
	 * If not given, the MIME type of each file will be detected by Tika.
	 * 
	...
	/**
	 * Optional parameter indicating whether to (recursively) include all
	 * sub-directories of the input directory.
	 */
	...
	public static CollectionReaderDescription configure(String inputDir, String mimeType)
	        throws UIMAException, IOException {
		return configure(inputDir, mimeType, false);
	}
	...
	public static CollectionReaderDescription configure(String inputDir, boolean recursive)
	        throws UIMAException, IOException {
		return configure(inputDir, null, recursive);
	}
	...
	public static CollectionReaderDescription configure(String inputDir) throws UIMAException,
	        IOException {
		return configure(inputDir, null);
	}
	...
	public void initialize(UimaContext ctx) throws ResourceInitializationException {
		...
		files = addFilesFromDir(inputDirectory, recursive);
	...
	public void getNext(CAS aCAS) throws IOException, CollectionException {
		CAS rawDocument = aCAS.createView(Views.CONTENT_RAW.toString());
