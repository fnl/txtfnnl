...
public class TokenBasedSemanticAnnotationFilter extends JCasAnnotator_ImplBase {
  ...
  public static class Builder extends AnalysisComponentBuilder {
    ...
    /**
     * Define the list of PoS tags that must match for a semantic annotation to be maintained.
     * <p>
     * Note that if this parameter is not set, the PoS tag is not checked. If the semantic
     * annotation spans multiple tokens, the <strong>last</strong> ("head") token is used as
     * reference. Unlike other parameters, if a semantic annotation has no PoS, and this parameter
     * is set, it is <em>not</em> filtered.
     * 
     * @param posTags
     * @return
     */
