...
public class TestSentenceLineWriter {
    ...
    public void testInitializeUimaContext() throws UIMAException, IOException {
        final AnalysisEngine slw =
            AnalysisEngineFactory.createPrimitive(SentenceLineWriter.configure());
    ...
    public void testProcessJCasDisableJoinLines() throws UIMAException, IOException {
        final AnalysisEngine slw =
            AnalysisEngineFactory.createPrimitive(SentenceLineWriter.configure(null, null, true,
                false, false));
        final String result =
            SENTENCE_1.trim() + System.getProperty("line.separator") + "  " + SEPARATOR + "  " +
                System.getProperty("line.separator") + SENTENCE_2.trim() +
    ...
    public void testProcessJCasOutputDir() throws UIMAException, IOException {
        ...
        final AnalysisEngine slw =
            AnalysisEngineFactory.createPrimitive(SentenceLineWriter.configure(tmpDir, "UTF-32",
                true, false, true));
        final String result =
            SENTENCE_1.replace('\n', ' ').trim() + System.getProperty("line.separator") +
                SEPARATOR + System.getProperty("line.separator") +
