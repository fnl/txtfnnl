...
public class TestFileReader {
    ...
    public void setUp() throws Exception {
        fileSystemReader =
            CollectionReaderFactory.createCollectionReader(FileReader.configure(new String[] {
                "src/test/resources/test.html", "src/test/resources/test-subdir/test-sub.html" }));
    ...
    private void setGetNextMockExpectations(String path) throws CASException {
        EasyMock.expect(baseCasMock.createView(Views.CONTENT_RAW.toString()))
