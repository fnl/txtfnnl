...
public class TestHTMLContentHandler {
	...
	/**
	 * Set up the test environment by attaching a mocked content handler to the
	 * HTML handler.
	 * 
	...
	public void setUp() {
		...
		assertFalse(handler.hadContent());
	}
	...
	/**
	 * Helper method to record a double newline handling event on the mocked
	 * handler.
	 * 
	 * @throws SAXException
	 */
	...
	/**
	 * Helper method to record a whitespace handling event on the mocked
	 * handler.
	 * 
	 * @throws SAXException
	 */
	...
	/**
	 * Ensure handling of characters that contain non-space characters at the
	 * end.
	 * 
	 * @throws SAXException
	 */
	...
	/**
	 * Ensure handling of characters that contain non-space characters in the
	 * middle.
	 * 
	 * @throws SAXException
	 */
	...
	/**
	 * Ensure that a double newline is added if in content context and double
	 * newline state.
	 * 
	 * @throws SAXException
	 */
	...
	/**
	 * Ensure a newline is added after an element that requires a newline is
	 * added is started, even if it is followed by any other element.
	 * 
	 * @throws SAXException
	 */
	@Test
	...
	/**
	 * Ensure a newline is added after an element that requires a newline is
	 * added is started, even if it is preceded by any other element.
	 * 
	 * @throws SAXException
	 */
	@Test
	...
	void dotestInsertAttributeSpaced(String attName, String tagName)
	        throws SAXException {
		String value = "value";
		char[] ch = "testing".toCharArray();
	...
	/**
	 * Ensure that the alt attribute values are followed by a newline when the
	 * element start requires inserting newlines.
	 * 
	 * @throws SAXException
	 */
	@Test
	...
	/**
	 * Ensure that the title attribute values are followed by a newline when the
	 * element start requires inserting newlines.
	 * 
	 * @throws SAXException
	 */
	...
	/**
	 * Ensure that the label attribute values are followed by a newline when the
	 * element start requires inserting newlines.
	 * 
	 * @throws SAXException
	 */
	...
	void dotestInsertAttributeNewlined(String attName, String tagName)
	        throws SAXException {
		String value = "value";
		AttributesImpl atts = new AttributesImpl();
	...
	/**
	 * Test that Greek letter name alts in img tags are translated to acutal
	 * Greek letters.
	 * 
	 * @throws SAXException
	 */
	...
	/**
	 * Test that capitalized Greek letter name alts in img tags are translated
	 * to actual upper-case Greek letters.
	 * 
	 * @throws SAXException
	 */
	@Test
	...
	/**
	 * Test that Greek letter name alts in img tags are not surrounded by
	 * spaces.
	 * 
	 * @throws SAXException
	 */
