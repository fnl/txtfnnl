...
/**
 * Extracts structured content from XML files following the Elsevier DTD 5
 * specification.
 * 
 * This handler adds in newlines where appropriate and removes consecutive
 * white-spaces/newlines/tabs to make the input more compact. Its inner
 * workings are similar to the HTML parser's.
 * 
