...
public class CleanWriteOutContentHandler extends WriteOutContentHandler {
   ...
   * is reached, then a {@link SAXException} is thrown. The {@link #isWriteLimitReached(Throwable)}
   ...
   * {@link #toString()} method to access the collected character content.
   * <p>
   * The internal string buffer is bounded at 1M characters. If this write limit is reached, then a
   * {@link SAXException} is thrown. The {@link #isWriteLimitReached(Throwable)} method can be used
   * to detect this case.
   */
