 ...
 * 
 * This special SAX handler extracts content for UIMA. It automatically
 * populates a CAS with the extracted plain-text and annotates the text with
 * the original structure of the content using
...
public class UIMAContentHandler extends ContentHandlerDecorator {
	...
	// XXX: should we create a content handler to normalize dash chars?
	 ...
	 * 
	 * Needs to have a view assigned first (setView(JCas)) and should have
	 * an annotator URI set (setAnnotatorURI(String)).
	 * 
