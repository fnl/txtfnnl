...
public class TikaWrapper {
    ...
    /**
     * Creates a Tika wrapper using the given detector instance and the default parser
     * configuration.
     * 
     * @param detector type detector
     */
     ...
     * <code>null</code>, in which case only the given document metadata is used for type
     * detection.
     * <p>
    ...
    /**
     * Append a language profiler to a content handler, returning an updated (tee'd) content
     * handler.
     * 
     ...
     */
    public void parse(InputStream stream, ContentHandler handler) throws IOException,
            TikaException {
    ...
    public ContentHandler parse(InputStream stream, Metadata metadata) throws IOException,
            TikaException {
        final CleanWriteOutContentHandler handler =
            new CleanWriteOutContentHandler(maxStringLength);
